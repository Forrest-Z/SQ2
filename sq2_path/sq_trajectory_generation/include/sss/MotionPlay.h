...
#ifndef SQ_TRAJECTORY_GENERATION_SERVICE_MOTIONPLAY_H
#define SQ_TRAJECTORY_GENERATION_SERVICE_MOTIONPLAY_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
#include "sq_trajectory_generation/path_params.h"
