...
int main(int argc,char** argv)
{
	...
	ros::init(argc, argv, "pc2local_map_visu");
    ros::NodeHandle n;
	ros::Rate roop(20);
	...
	ros::Publisher pub_map = n.advertise<nav_msgs::OccupancyGrid>("/local_map/debug", 1);
